...
public class CMDFrame extends JFrame {
	 ...
	 */
	public CMDFrame() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CMDFrame.class.getResource("/Image/ShortLogo.jpg")));
		setTitle("AxineCMD");
	...
	public static void setTextCMD(String textCMD) {
		CMDFrame.textCMD.setText(textCMD);
	}
	...
	public static void setScrollPane(JScrollPane scrollPane) {
		CMDFrame.scrollPane = scrollPane;
	}
